...
export namespace Token {
    ...
    export interface deployData extends baseData, timed, Meta, Readonly<{cap: number; rarity: number; val: number}> {}
    export interface deployDataContract extends baseData, timed, Readonly<{cap: number; rarity: number; val: number}> {}
